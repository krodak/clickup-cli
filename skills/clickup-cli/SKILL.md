...
# ClickUp CLI (`cup`) - skill version 1.31.0

Reference for AI agents using the `cup` CLI tool. Covers task management, sprint tracking, comments, time tracking, custom fields, goals, docs, and project workflows.

> **Version check:** Run `cup --version`. If your installed version is older than 1.31.0, update with `npm install -g @krodak/clickup-cli` and refresh this skill with `cup skill`.
